...
\psfrag{assb}[c][c] {\footnotesize $\textsc{All-solid-state Batteries }$}
\psfrag{abr}[c][c]  {\footnotesize $\textsc{(ASSBs)}$}
...
\includegraphics[width=0.6\textwidth]{routine_woTV_spectral_boschcolor.eps}