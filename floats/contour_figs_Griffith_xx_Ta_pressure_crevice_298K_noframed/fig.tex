...
\psfrag{s1}[c][c] {\footnotesize $\text{a}_{\text{crevice}}\!=1\%$}
\psfrag{s2}[c][c] {\footnotesize $\text{a}_{\text{crevice}}\!=5\%$}
\psfrag{s3}[c][c] {\footnotesize $\text{a}_{\text{crevice}}\!=10\%$}
\psfrag{s4}[c][c] {\footnotesize $\text{a}_{\text{crevice}}\!=30\%$}
\psfrag{s5}[c][c] {\footnotesize $\text{a}_{\text{crevice}}\!=50\%$}
...
\psfrag{tt2}[c][c] {\footnotesize Percentage of pre-existing crevice per unit length at (Li$|$$\{\textbf{50}\text{Ta}^{\bullet}_{\text{Zr}}\}$-LLZO)-Interface}
