...
\block{\bfseries Mathematical modelling for the next-generation All-solid-state batteries: Nucleation $\text{(SE|SSE)}^{\!(*)}$-interface}
{
	\begin{minipage}{0.56\textwidth}
		...
		\begin{mdframed}
			\textbf{Aim}: 
			This is with the purpose of getting a better insight into 
			dendrite formation
		\end{mdframed}
	\end{minipage}%
	\hfill
...
\begin{columns}
	...
	{
		\textbf{Griffith} nucleation criterion governs the unstable (SE|SSE)-interface \cite{hueter2017}
		\begin{center}
	...
	{
		\textbf{Space-charge Layer} \cite{braun2015}
...
\begin{columns}
	...
	\block{References}{
		...
		\begin{thebibliography}{2}
			...
			Poster, Oxford Batt. Modelling Symposium, University of Oxford, OBMS23, P. 66, \textbf{2023}.
			
			\bibitem{vo2023}
			\textbf{T.Vo}, C.Hüter, S.Braun, M.Torrilhon,
			\emph{Next-generation All-solid-state Battery (\#ASSB)}.
	...
	\block{Acknowledgments}{
		...
		in the courses of 
		Mathematische Grundlagen II, III, IV, and NumPDE
		at CES and SiSc at 
		RWTH Aachen University
		was made possible
		thanks to the guidance and mentorship of
		Prof.\,Dr.\,M.Torrilhon,
		Prof.\,Dr.\,M.Schlott-Lakemper,
		Dr.\,R.Speck,
		Prof.\,Dr.\,B.Berkels,
		Dr. S. Braun,
		Prof.\,Dr.\,J.Kowalski,
