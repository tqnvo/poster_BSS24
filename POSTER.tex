	...
	\begin{minipage}{0.56\textwidth}
		\begin{minipage}{0.5\textwidth}
			\begin{mdframed}
				...
				This bottleneck is
				mainly due to \textcolor{red}{liquid-based electrolyte} 
				found in c-LIBs.
			\end{mdframed}
		\end{minipage}
		%
		...
		\begin{mdframed}
			\textbf{Aim}: 
			The study is with the purpose of getting a better insight into 
			dendrite formation in ASSB
		\end{mdframed}
	\end{minipage}%
	\hfill
...
\begin{columns}
	...
	{
		\textbf{Griffith nucleation} governs the (SE|SSE)-Interface \cite{hueter2017}
		\begin{center}
