...
\begin{columns}
	...
	{
		\textbf{Griffith nucleation criterion} governs (SE|SSE)-Interface.
		\begin{center}
	...
	{
		\textbf{SCL} presents in ASSB \cite{braun2015}, and likewise in Semiconductors.
	...
	% ---------------------------------------------------------------------------------------------------------------- %
	\column{0.338}
	\block{Energy density landscape}{
		ASSB enables energy demand thanks to (i), and followed by (ii).
...
\begin{columns}
	\column{0.24}
	{
		\block{Artificial Neural Networks}
		{
			...
			enhances bainitic transformation temperature prediction, 
			validated using ANNs \cite{hueter2020}.
		...
		\block{Semiconductor}
		{
			\textbf{Application}: Bosch Start/Stop Starter System.\\
			\textbf{Test-case}: BMW B47 engine.\\
			\textbf{Optimisation}: Pareto multi-objectives.
			\begin{center}
		...
		{
			\textbf{Application}: Swelling phenomena.\\
